...
namespace OMSApi.Controllers
{
    ...
    [Route("ext/ord/sc/api/subscription")]
    public class SubscriptionExtScController : ControllerBase
    {
        private readonly IOrderSubscriptionService orderSubscriptionService;
        public SubscriptionExtScController(IOrderSubscriptionService orderSubscriptionService)
        {
        ...
        {
            var res = await orderSubscriptionService.SubscribeAsync<ResultDataObject<SubscriptionOrder>>(User.UserIdentifier(), userDesc, User.ClientId(), QueryType.Orders);
            if (res == null)
        ...
        {
            var res = await orderSubscriptionService.SubscribeAsync<ResultDataObject<SubscriptionOrder>>(User.UserIdentifier(), userDesc, User.ClientId(), QueryType.OpenOrders);
            if (res == null)
                return BadRequest("Failure!");
            return Ok(res);
        }
        ...
        {
            var res = await orderSubscriptionService.SubscribeAsync<ResultDataObject<SubscriptionExecution>>(User.UserIdentifier(), userDesc, User.ClientId(), QueryType.Executions);
            if (res == null)
                return BadRequest("Failure!");
            return Ok(res);
        }
        ...
        {
            var res = await orderSubscriptionService.SubscribeAsync<ResultDataObject<SubscriptionPosition>>(User.UserIdentifier(), userDesc, User.ClientId(), QueryType.Positions);
            if (res == null)
                return BadRequest("Failure!");
            return Ok(res);
        }
