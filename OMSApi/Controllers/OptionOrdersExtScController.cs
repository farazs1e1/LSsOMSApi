...
namespace OMSApi.Controllers
{
    ...
    [Route("ext/ord/sc/api/optionorders")]
    public class OptionOrdersExtScController : ControllerBase
    {
        private readonly IOrderManagementService orderManagementService;

        public OptionOrdersExtScController(IOrderManagementService orderManagementService)
        {
            this.orderManagementService = orderManagementService;
        }

        [HttpPost]
        public async Task<IActionResult> CreateOrderAsync([Required] string userDesc, OptionOrderRequest orderRequest)
        {
