...
namespace OMSApi.Controllers
{
    ...
    [Route("ext/ord/api/subscription")]
    public class SubscriptionExtController : ControllerBase
    {
        private readonly IOrderSubscriptionService orderSubscriptionService;
        public SubscriptionExtController(IOrderSubscriptionService orderSubscriptionService)
        {
        ...
        {
            var res = await orderSubscriptionService.SubscribeAsync<ResultDataObject<SubscriptionOrder>>(User.UserIdentifier(), User.OriginatingUserId(), User.ClientId(), QueryType.Orders);
            if (res == null)
        ...
        {
            var res = await orderSubscriptionService.SubscribeAsync<ResultDataObject<SubscriptionOptionOrder>>(User.UserIdentifier(), User.OriginatingUserId(), User.ClientId(), QueryType.OptionOrders);
            if (res == null)
                return BadRequest("Failure!");
            return Ok(res);
        }
        ...
        {
            var res = await orderSubscriptionService.SubscribeAsync<ResultDataObject<SubscriptionOrder>>(User.UserIdentifier(), User.OriginatingUserId(), User.ClientId(), QueryType.OpenOrders);
            if (res == null)
                return BadRequest("Failure!");
            return Ok(res);
        }
        ...
        {
            var res = await orderSubscriptionService.SubscribeAsync<ResultDataObject<SubscriptionExecution>>(User.UserIdentifier(), User.OriginatingUserId(), User.ClientId(), QueryType.Executions);
            if (res == null)
                return BadRequest("Failure!");
            return Ok(res);
        }
        ...
        {
            var res = await orderSubscriptionService.SubscribeAsync<ResultDataObject<SubscriptionPosition>>(User.UserIdentifier(), User.OriginatingUserId(), User.ClientId(), QueryType.Positions);
            if (res == null)
                return BadRequest("Failure!");
            return Ok(res);
        }
