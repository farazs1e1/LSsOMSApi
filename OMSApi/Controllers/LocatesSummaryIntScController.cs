...
namespace OMSApi.Controllers
{
    ...
    [Route("int/ord/sc/api/locates/summary")]
    public class LocatesSummaryIntScController : ControllerBase
    {
        private readonly ILocatesService locatesService;
        public LocatesSummaryIntScController(ILocatesService locatesService)
        {
