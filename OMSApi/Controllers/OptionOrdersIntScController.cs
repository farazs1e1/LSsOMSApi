...
namespace OMSApi.Controllers
{
    ...
    [Route("int/ord/sc/api/optionorders")]
    public class OptionOrdersIntScController : ControllerBase
    {
        private readonly IOrderManagementService orderManagementService;

        public OptionOrdersIntScController(IOrderManagementService orderManagementService)
        {
            this.orderManagementService = orderManagementService;
        }

        [HttpPost]
        public async Task<IActionResult> CreateOrderAsync([Required] string userDesc, OptionOrderRequestInt orderRequest)
        {
