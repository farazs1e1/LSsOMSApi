...
namespace OMSApi.Controllers
{
    ...
    [Route("int/ord/sc/api/account/balances")]
    public class AccountBalancesIntScController : ControllerBase
    {
        private readonly IAccountBalancesService accountBalancesService;
        public AccountBalancesIntScController(IAccountBalancesService accountBalancesService)
        {
