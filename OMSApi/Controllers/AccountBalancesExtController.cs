...
namespace OMSApi.Controllers
{
    ...
    [Route("ext/ord/api/account/balances")]
    public class AccountBalancesExtController : ControllerBase
    {
        private readonly IAccountBalancesService accountBalancesService;
        public AccountBalancesExtController(IAccountBalancesService accountBalancesService)
        {
